...
import emoji # needed for printing
...
parser.add_argument('--models_dir', metavar='MODELS_DIR', type=str, default='models', help='Path to parent folder containing model subfolders')
...
def main():
	...
	if args.model_name != '124M': # if args.model_name == '355M':
	...
	with tf.Session(config=config) as sess:
		...
		def generate_samples():
			...
			# needed for printing emojis
			text_to_print = emoji.demojize(text).encode('utf-8').decode('utf-8','ignore')
			print(text_to_print)
